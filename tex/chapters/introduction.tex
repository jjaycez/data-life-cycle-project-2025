...
de crisis respiratorias o contribuyen al desarrollo de asma en la población infantil son especialmente prevalentes.

La siguiente figura, extraído de ~\cite{Ni2024PM25Asthma}, ilustra cómo aproximadamente un tercio de los casos de asma están
relacionados con la exposición a largo plazo de materia particulada fina ($\pmtwofive$):

\begin{figure}[H]
    \centering
    \includegraphics[width=0.7\linewidth]{figures/one_earth_poster}
    \caption{Portada del artículo de One Earth~\cite{Ni2024PM25Asthma}}
    \label{fig:one_earth_poster}
\end{figure}

Más concretamente, el artículo afirma que cada incremento de $10\,\mu g/m^3$ en la concentración de $\pmtwofive$ se
asocia con un aumento del riesgo de:

\begin{itemize}
    \item $\approx 21.4\%$ en niños (intervalo de confianza del $95\%$: $11.4\%-32.3\%$)
    \item $\approx 7.1\%$ en adultos (intervalo de confianza del $95\%$: $1.6\%-12.9\%$)
\end{itemize}
