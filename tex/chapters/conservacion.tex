...
En regiones con un alto desarrollo logístico e industrial, como California, el aire se carga de contaminantes que actúan como detonantes de crisis respiratorias.
	...
	% --- CAPÍTULO 4: PLAN DE PRESERVACIÓN ---
	\chapter{Plan de Preservación}
	...
	\subsection{Almacenamiento físico}
    ...
    \subsection{Limpieza y curación}
	...
	\subsection{Acceso y reutilización}
	...
	\section{Estrategia de preservación a largo plazo}
